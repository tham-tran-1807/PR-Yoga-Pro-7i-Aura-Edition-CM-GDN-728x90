...
lib.ssMetadata = [
		{name:"PR_Yoga_Pro_7i_Aura_Edition_CM_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,184,686,90],[0,460,415,90],[0,368,445,90],[417,460,393,90],[447,368,442,90],[525,276,420,90],[0,552,356,85],[0,276,523,90],[0,92,709,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_Pro_7i_Aura_Edition_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYogaPro7iAuraEditionCMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(360).to({_off:false},0).to({y:10.45},12).wait(18));
	...
	this.instance_1.setTransform(134,0);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(350).to({_off:false},0).wait(40));

	// F7
	this.instance_2 = new lib.F7();
	this.instance_2.setTransform(278,2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(299).to({_off:false},0).to({_off:true},51).wait(40));

	// F6
	this.instance_3 = new lib.F6();
	this.instance_3.setTransform(189,0);
	...
	this.instance_4.setTransform(119,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(199).to({_off:false},0).to({_off:true},51).wait(140));

	// F4
	this.instance_5 = new lib.F4();
	this.instance_5.setTransform(180,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(149).to({_off:false},0).to({_off:true},50).wait(191));

	// F3
	this.instance_6 = new lib.F3();
	this.instance_6.setTransform(199,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({_off:false},0).to({_off:true},49).wait(241));

	// F2
	this.instance_7 = new lib.F2();
	this.instance_7.setTransform(153,0);
	...
	this.instance_8.setTransform(42,0);
...
// library properties:
lib.properties = {
	id: '06EBA0A4B555734E8DD739D6109EC3F9',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_Pro_7i_Aura_Edition_CM_GDN_728x90_atlas_1.png", id:"PR_Yoga_Pro_7i_Aura_Edition_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['06EBA0A4B555734E8DD739D6109EC3F9'] = {
